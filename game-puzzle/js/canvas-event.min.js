(function() {
    ...
    J("mousemove mouseover mouseout mousedown mouseup click dblclick focus blur".split(" "),
    function(P) {
        C.fn[P] = function(R, Q) {
            var S;
            if (B(Q, t)) {
    ...
    J("keydown keypress keyup".split(" "),
    function(P) {
        C.fn[P] = function(Q, R) {
            if (!R && B(Q, t)) {
                R = Q;
